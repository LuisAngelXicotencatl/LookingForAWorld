...
$juegos = "SELECT `busqueda`.`id_busqueda`, `busqueda`.`id_juego`, `busqueda`.`sinonimo`, `juegos`.`nombre`, `juegos`.`portada`, `juegos`.`descripcionCorta`
FROM `busqueda` 
LEFT JOIN `juegos` ON `busqueda`.`id_juego` = `juegos`.`id_juego`
WHERE  sinonimo= '$descripcion'";
